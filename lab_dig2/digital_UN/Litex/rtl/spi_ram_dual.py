...
class SpiRamDualQuad(Module, AutoDoc):
    def __init__(self, pads_1, dummy=6, endianness="big", reset_cycles=2**14-1, qpi=True):
...

            {
              "signal": [
                ["Read",
                    ...
                    {  "name": 'SI',      "wave": 'x22222222xxxxxx22x', "data": '1 1 20 16 12 8  4 0 4 0'},
                    {  "name": 'SO',      "wave": 'x22222222xxxxxx22x', "data": '1 0 21 17 13 9  5 1 5 1'},
                    {  "name": 'D2',      "wave": 'x22222222xxxxxx22x', "data": '1 1 22 18 14 10 6 2 6 2'},
                    {  "name": 'D3',      "wave": 'x22222222xxxxxx22x', "data": '0 1 23 19 15 11 7 3 7 3'},
                    {  "name": 'meaning', "wave": 'x2.2.....2.....2.x', "data": ['cmd: 0xEB', 'address', 'HI-Z 6 wait cycles', 'data'] },
                    ],
        ...
        .. wavedrom::
...

            {
                ...
                ["Write",
                    {  "name": 'CLK',     "wave": 'xp.........x', "data": ''   },
                    {  "name": 'CS',      "wave": '10.........1', "data": ''   },
                    {  "name": 'SI',      "wave": 'x2222222222x', "data": '0 1 20 16 12 8  4 0 4 0'},
                    {  "name": 'SO',      "wave": 'x2222222222x', "data": '0 0 21 17 13 9  5 1 5 1'},
                    {  "name": 'D2',      "wave": 'x2222222222x', "data": '1 0 22 18 14 10 6 2 6 2'},
                    {  "name": 'D3',      "wave": 'x2222222222x', "data": '1 0 23 19 15 11 7 3 7 3'},
...
#            ),
        ...
        fsm.act("SEND_CMD",
            ...
            If(cycle_counter == cmd_width//spi_width - 1,
                cycle_counter_reset.eq(1),
                # Wishbone addresses are 32-bits.  Litex Wishbone addresses are 30 bits (32 bits).
        ...
        fsm.act("SEND_DATA",
            ...
            clk.eq(~ClockSignal()),
            NextValue(sr, Cat(Signal(spi_width), sr)),
            If(cycle_counter == wbone_width//spi_width - 1,
                cycle_counter_reset.eq(1),
                NextState("IDLE"),
                bus.ack.eq(1),
            ),
        ...
        fsm.act("RECV_DATA",
            ...
            If(cycle_counter == wbone_width//spi_width + 1,
                ...
                NextValue(sr, Cat( dq1.i, sr[:-spi_width])),
