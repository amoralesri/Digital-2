...
_io_v6_0 = [
    ...
    ("led_panel", 0,
        Subsignal("LP_CLK", Pins("M3"),          IOStandard("LVCMOS33")),
        Subsignal("LATCH",  Pins("N1"),          IOStandard("LVCMOS33")),
        Subsignal("NOE",    Pins("M4"),          IOStandard("LVCMOS33")),
        Subsignal("ROW",    Pins("N5 N3 P3 P4 N4"),          IOStandard("LVCMOS33")),
        Subsignal("RGB0",   Pins("J13 K13 J12"),          IOStandard("LVCMOS33")),
        Subsignal("RGB1",   Pins("H13 H12 G12"),          IOStandard("LVCMOS33")),
    ),
...
class Platform(LatticeECP5Platform):
    ...
    def __init__(self, revision="6.0", toolchain="trellis"):

        LatticeECP5Platform.__init__(self, "LFE5U-25F-6BG256C", _io_v6_0, connectors= _connectors_v6_0, toolchain=toolchain)
