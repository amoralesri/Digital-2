...
_io = [
    ...
    ("led_panel", 0,
        Subsignal("LP_CLK", Pins("L11"),          IOStandard("LVCMOS33")),
        Subsignal("LATCH",  Pins("K11"),          IOStandard("LVCMOS33")),
        Subsignal("NOE",    Pins("K5"),          IOStandard("LVCMOS33")),
        Subsignal("ROW",    Pins("A10 A11 E10 E11 C11"),          IOStandard("LVCMOS33")),
        Subsignal("RGB0",   Pins("G10 G11 D10"),          IOStandard("LVCMOS33")),
        Subsignal("RGB1",   Pins("B10 B11 C10"),          IOStandard("LVCMOS33")),
    ),
]
